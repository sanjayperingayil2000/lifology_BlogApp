...
"[project]/graphql/schema.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/utils/auth.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/graphql/resolvers.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/auth.ts [app-route] (ecmascript)");
;
;
;
const resolvers = {
    Query: {
        posts: async ()=>await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post.findMany({
                include: {
                    author: true
                }
            }),
        post: async (_, { id })=>{
            // Ensure that `id` is an integer before passing it to Prisma
            const postId = parseInt(id, 10); // Convert string to number
    ...
    Mutation: {
        signup: async (_, { email, password, name })=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateToken"])(user.id);
        },
        ...
        updatePost: async (_, { id, title, content, imageUrl }, { userId })=>{
            ...
            return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post.update({
                where: {
                    id: postId
                },
                data: {
        ...
        deletePost: async (_, { id }, { userId })=>{
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post.delete({
                where: {
                    id: postId
                }
            });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$graphql$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/graphql/schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$graphql$2f$resolvers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/graphql/resolvers.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/auth.ts [app-route] (ecmascript)");
...
const server = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApolloServer"]({
    typeDefs: __TURBOPACK__imported__module__$5b$project$5d2f$graphql$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["typeDefs"],
    resolvers: __TURBOPACK__imported__module__$5b$project$5d2f$graphql$2f$resolvers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolvers"]
});
const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$as$2d$integrations$2f$next$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startServerAndCreateNextHandler"])(server, {
    context: async (req)=>{
        ...
        if (token) {
            try {
                const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token);
        ...
        return {
            prisma: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
            userId
        };
    }
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__47cd93._.js.map