...
(()=>{
    const e = new Error("Cannot find module 'next/navi'");
...
;
;
const GET_POST = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2d$tag$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gql"]`
...
const BlogPost = ()=>{
    ...
    const { data, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])(GET_POST, {
        variables: {
            id: Number(id)
        }
    });
...
//# sourceMappingURL=app_blog_%5Bid%5D_page_tsx_5100af._.js.map